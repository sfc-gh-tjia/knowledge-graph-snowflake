...
-- Navigate to: Data → Databases → KNOWLEDGE_GRAPH_DB → SOCCER_KG → Stages → SOCCER_GRAPH_SERVICE_SPEC
...
CREATE OR REPLACE SERVICE soccer_mcp_server
  ...
  FROM SPECIFICATION '@"KNOWLEDGE_GRAPH_DB"."SOCCER_KG"."SOCCER_GRAPH_SERVICE_SPEC"/service.yaml';
...
echo "   - Go to: Data → Databases → KNOWLEDGE_GRAPH_DB → SOCCER_KG → Stages"
