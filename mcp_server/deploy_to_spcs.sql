...
-- Option B: Upload manually via Snowflake UI: Data → Databases → KNOWLEDGE_GRAPH_DB → SOCCER_KG → Stages → soccer_graph_service_spec
...
CREATE SERVICE soccer_graph_analytics_service
  ...
  FROM @"KNOWLEDGE_GRAPH_DB"."SOCCER_KG"."SOCCER_GRAPH_SERVICE_SPEC"
