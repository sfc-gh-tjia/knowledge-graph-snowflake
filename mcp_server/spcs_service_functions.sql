...
• Custom tool identifier: KNOWLEDGE_GRAPH_DB.SOCCER_KG.SHORTEST_PATH_TOOL
• Parameters:
...
• Resource type: Function
• Custom tool identifier: KNOWLEDGE_GRAPH_DB.SOCCER_KG.CENTRALITY_TOOL
• Parameters:
  - graph_type (STRING, required): "Type of graph: 'player' or 'club'"
...
• Resource type: Function
• Custom tool identifier: KNOWLEDGE_GRAPH_DB.SOCCER_KG.COMMUNITY_DETECTION_TOOL
• Parameters:
  - graph_type (STRING, required): "Type of graph: 'player' or 'club'"
• Warehouse: COMPUTE_WH
...
• Resource type: Function
• Custom tool identifier: KNOWLEDGE_GRAPH_DB.SOCCER_KG.TRANSFER_ANALYSIS_TOOL
• Parameters:
...
• Resource type: Function
• Custom tool identifier: KNOWLEDGE_GRAPH_DB.SOCCER_KG.TEMPORAL_ANALYSIS_TOOL
• Parameters:
